...
module ascii_sender_control_unit(
	...
	parameter [3:0] SR04_MSG = 4;
	parameter [3:0] BS_SR04 = 5;
	parameter [3:0] SR04_DATA = 6;
	parameter [3:0] TEMP_MSG = 7;
	parameter [3:0] BS_TEMP = 8;
	parameter [3:0] TEMP_DATA = 9;
	parameter [3:0] HUM_MSG = 10;
	parameter [3:0] BS_HUM = 11;
	parameter [3:0] HUM_DATA = 12;
	parameter [3:0] STOP = 13;
