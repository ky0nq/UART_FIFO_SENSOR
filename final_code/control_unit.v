...
module control_logic(
	...
	parameter [3:0] STOP = 0;
	parameter [3:0] RUN = 1;
	parameter [3:0] CLEAR = 2;
	parameter [3:0] MODE = 3;
	parameter [3:0] WATCH = 4;
	parameter [3:0] HOUR = 5;
	parameter [3:0] MIN = 6;
	parameter [3:0] SEC = 7;
	// Sensor State
	parameter [3:0] SR04_WAIT = 8;
	parameter [3:0] SR04_START = 9;
	parameter [3:0] SR04_STOP = 10;
	parameter [3:0] DHT_WAIT = 11;
	parameter [3:0] DHT_START = 12;
	parameter [3:0] DHT_STOP = 13;
