...
module fnd_controller #(
    ...
    input rst,
    input sw9,
    // hour converter에 해당 data_type_sel sw[1] 넣기
    input [1:0] data_type_sel,  // sw[3], sw[0] 조합
    input [1:0] fnddata_type_sel,  // sw[3], sw[1] 조합
    input [2:0] place_sel,
    input [23:0] fnd_in,
    output [3:0] fnd_com,
    output [7:0] fnd_data,
    ...
    digit_data_merge U_SR04_DATA_MERGE (
        ...
        .in4             (w_sr04_digit_1),
        .in5             (w_sr04_digit_10),
        .in6             (w_sr04_digit_100),
        .in7             (w_sr04_digit_1000),
